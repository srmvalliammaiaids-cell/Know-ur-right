...
import { Mic, Shield, Users, Zap, Globe, Phone, ChevronRight, Play, CheckCircle2 } from 'lucide-react';
...
const LandingPage = () => {
  ...
  const features = [
    {
      ...
      description: 'Speak in your language. No typing needed.',
      color: '#FF6B00'
    },
    {
      icon: Globe,
      title: '8 Indian Languages',
      description: 'Hindi, Tamil, Telugu, Kannada, Malayalam, Bengali, Marathi, English',
      color: '#00E676'
    },
    {
      icon: Shield,
    ...
    },
    {
      icon: Zap,
      title: 'Free & Fast',
      description: 'No lawyers needed for basic legal queries',
      color: '#FF4081'
    }
  ];

  const stats = [
    { number: '40M+', label: 'Pending Court Cases', color: '#FF6B00' },
    { number: '1.4B', label: 'Citizens Served', color: '#00E676' },
    { number: '8', label: 'Languages', color: '#D500F9' },
    { number: 'Free', label: 'Always Free', color: '#FF4081' }
  ];

  const team = [
    { name: 'AI Legal Assistant', role: 'Powered by Google Gemini', image: 'https://images.unsplash.com/photo-1595956481935-a9e254951d49?w=400' },
    { name: 'Voice Technology', role: 'Multilingual Support', image: 'https://images.unsplash.com/photo-1560885673-4e2f056f6e2a?w=400' }
  ];
  ...
  return (
    <div className={"min-h-screen bg-[#0A0D29] text-white overflow-hidden"} data-testid=\"landing-page\">
        ...
        <div className={"max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10\">
          ...
          >
            ...
            <p className={"text-xl text-white/80 mb-8 leading-relaxed\">
              AI-powered legal rights decoder for every Indian citizen. Get instant legal guidance in your language. No lawyers needed for basic queries.
            </p>
            <div className={"flex flex-wrap gap-4\">
              ...
              <button
                className={"min-h-[48px] px-8 rounded-xl font-semibold text-lg border-2 border-[#D500F9] text-[#D500F9] hover:bg-[#D500F9]/10 transition-all flex items-center gap-2\"
          ...
          <motion.div
            ...
            className={"relative\"
          >
            <div className={"relative card p-8 shadow-[0_0_60px_rgba(255,107,0,0.3)]"} animate-float\">
      ...
      {/* How It Works */}
      <section className={"py-20 px-4 bg-[#111742]/30\">
        <div className={"max-w-5xl mx-auto\">
          ...
          <div className={"space-y-8\">
            {[
              { step: 1, title: 'Speak Your Problem', desc: 'Use voice or type in your language', color: '#FF6B00' },
              { step: 2, title: 'AI Analyzes', desc: 'Get your rights explained in simple language', color: '#00E676' },
              { step: 3, title: 'Take Action', desc: 'Step-by-step guidance and legal notices', color: '#D500F9' }
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                <div 
                  className={"w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 font-bold text-2xl text-white\"
      ...
      <section className={"py-20 px-4\">
        <div className={"max-w-7xl mx-auto\">
          <motion.div
            ...
            className={"text-center mb-16\"
          >
            <h2 className={"text-3xl md:text-4xl mb-4\">Powered By</h2>
            <p className={"text-xl text-white/70\">Cutting-edge AI technology</p>
          </motion.div>
            ...
            {team.map((member, index) => (
              ...
              >
                <img 
                  src={member.image}
                  alt={member.name}
                  className={"w-32 h-32 rounded-full mx-auto mb-4 object-cover border-4 border-[#FF6B00]\"
                />
        ...
        <div className={"max-w-4xl mx-auto text-center\">
          ...
          >
            <h2 className={"text-3xl md:text-5xl mb-6\">
              Ready to Find Your Rights?
            </h2>
            <p className={"text-xl text-white/80 mb-8\">
              Join thousands of Indians getting instant legal guidance
            </p>
            <button
              onClick={() => navigate('/login')}
